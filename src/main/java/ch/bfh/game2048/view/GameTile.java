...
import ch.bfh.game2048.view.model.UITheme;
...
public class GameTile extends Label {
	...
	/**
	 * 
	 * Scale label-text based on: - label-size - tile-value's amount of digits
	 * 
	 * @param tileText
	 * @return
	 */
	...
	private Text scaleLabelText(Text tileText) {
		...
		/*
		 * factorX = temporary factor to scale text-width factorY = temporary
		 * factor to scale text-height
		 */
		 ...
		 * prevents text from exceeding tile-border - maintains the
	...
	/**
	 * Set a label's... - Font-weight - Background-color - Border-color -
	 * Border-width
	 */
